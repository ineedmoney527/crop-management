  ...
  return (
    <Card sx={{ maxWidth: 370, borderRadius: 3 }}>
        ...
        subheader={
          <div>
            ...
            <Typography paragraph color="#808E7C">
              Quantity in Stock: {seed.quantity}
            </Typography>
          </div>
        }
        className="Header2"
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CardContent>
          <Typography variant={"h6"} fontWeight={"bold"} color="#3F4736">
            Additional Info:
          </Typography>
          <Typography paragraph color="#808E7C">
          ...
          <Typography paragraph color="#808E7C">
            Supplier: {seed.user_id} {/* Display supplier name */}
          </Typography>
        </CardContent>
      </Collapse>
    </Card>
