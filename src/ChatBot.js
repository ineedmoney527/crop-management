    ...
    return (
        <div className="chat-container">
            ...
            <div className="chat-messages">
                ...
                <button className="dropbtn" onClick={toggleDropdown}>ChatBot 1.0 <i className="fa fa-caret-down"></i></button>
                ...
                <div className={"suggestion1"}>
                        <button className={"suggestion-button"} onClick={handleOption1Click}>option 1</button>
                        <button className={"suggestion-button"} onClick={handleOption1Click}>option 2</button>
                    </div>
                    <div className={"suggestion2"}>
                        <button className={"suggestion-button"} onClick={handleOption1Click}>option 3</button>
                        <button className={"suggestion-button"} onClick={handleOption1Click}>option 4</button>
                    </div>
                </div>
