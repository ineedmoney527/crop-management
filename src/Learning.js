...
const TitlebarImageList = ({handleChapterClick}) => {
  return (
      <ImageList sx={{ width: '100%', height: 'auto' }}>
        ...
        {itemData.map((item) => (
            <ImageListItem key={item.img} sx={{ margin: '10px',borderRadius:'10px'}}>
              <img
                  src={item.img}
                  alt={item.title}
              ...
              <ImageListItemBar
                  ...
                  actionIcon={
                    <Button
                        ...
                        style={{width:'26px',height:'30px',display:'flex',justifyContent:'center',alignItems:'center',marginRight:'10px'}}
                    />
                  }
...
const Learning = () => {
  ...
  return (
      <div style={{display:'flex',flexDirection:'row'}}>
        ...
        <div style={{flex: 1, overflowY: 'auto', alignItems: 'center', padding: '10px'}}>
