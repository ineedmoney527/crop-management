    ...
    <div className={"post"}>
        <Stack direction="column" spacing={1} className={"EachSinglePost"}>
            ...
            <div className={"post-content"}>
                ...
                <Stack direction="row" spacing={2} justifyContent="space-between" className={"postActions"}>
                    <form>
                        <input
                    ...
                    <Stack direction="row" spacing={2} className={"buttonsAction"}>
                        <button className={"buttonInteraction"} onClick={handleCommentClick} type="submit"><FaRegComment size={15}/> Comments</button>
                        <button className={"buttonInteraction"} onClick={() => onLike(post.id)}><CiHeart size={23} /></button>
                        <button className={"buttonInteraction"} onClick={() => onStar(post.id)}><CiStar size={23}/></button>
                    </Stack>
