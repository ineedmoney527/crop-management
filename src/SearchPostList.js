...
//       avatar: null,
//       timestamp: new Date(),
//       images: [{ url: veg5, alt: "Post Image" }],
//       follower: "3 followers",
//       sign: null,
//       caption:
//         "Carrot farmer and lover are here! Carrots are not just crunchy snacks but also packed with vitamins and nutrients essential for good health. The vibrant orange color of carrots comes from beta-carotene, which is beneficial for eye health. Grated carrots add a delightful crunch and sweetness to salads and coleslaws. Roasted carrots with a sprinkle of herbs make a delicious and healthy side dish for any meal.",
//       // Add other post data such as media content (images/videos) if needed
//     },
//   ];
