        ...
        <div className="chat-container">
            <div className={"chat_sidebar"}>
                <div className={"chat-sidebar-box"}>
                    ...
                    <button className={"sidebar-button"}>Gamification</button>
                </div>
            </div>
                ...
                <div className={"gamification-content"}>
                    <div className={"personal"}>
                        ...
                        <div className={"personal-information"}>
                            ...
                            <progress value="5" max="10" className={"level-progress"}></progress>
                            <label>Ranking: Silver</label>
                        </div>
                    </div>

                    <div className={"accomplishment-button"}>
                        <button className={showAllGoals ? "accomplishment-button-not-select" : "accomplishment-button"}
                                onClick={toggleView}>Current
                        </button>
                        <button className={showAllGoals ? "accomplishment-button" : "accomplishment-button-not-select"}
                                onClick={toggleView}>All Goals
                        </button>
                    </div>
