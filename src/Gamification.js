...
const Gamification = () => {
  ...
  const sortedGamificationData = [...gamificationData].sort((a, b) => a.ranking - b.ranking);
  ...
  const renderBadgeItems = () => {
    return [
      ...
      { image: '/images/badges4.png', title: "Plant badge", index: 3 }
        ...
        <div key={index} className={"badge-item"}>
          <div className="badge-container" style={{justifyContent:'center',alignItems:'center',display:'flex'}}>
            <img src={badge.image} alt={"badge"} className="badge-image"/>
            {badgeLocks[badge.index] ? ( // Render lock icon only if badge is locked
                <LockIcon className="lock-icon" style={{width: '45px', height: '45px',marginTop:'auto',marginBottom:'auto'}}/>
            ) : null}
          </div>
          <div style={{display:'flex',justifyContent:'flex-start'}}>
            <label style={{width:'170px',fontSize:'16px'}}>{badge.title}</label>
  ...
  return (
      ...
      <div style={{width:'100%',height:'100%'}}>
        ...
        <div style={{
          ...
          <div style={{display: 'flex', flexDirection: 'column',width:'100%',justifyContent:'center',marginLeft:'30px'}}>
                  ...
                  <div className={"personal"}
                    ...
                    <div className={"personal-information"}>
                      ...
                      <div className={"personal-information-group"} style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', marginBottom: '10px' }}>
                        <label className={"personal-information-label"} style={{ width: '150px', textAlign: 'left', paddingRight: '10px' }}>Level:</label>
                        <label className={"personal-information-value"} style={{textAlign: 'left'}}>{userData.level}</label>
                      </div>
                      <div className={"personal-information-group"} style={{
                        display: 'flex',
                        ...
                        <label className={"personal-information-label"}
                               style={{width: '150px'}}>Progress:</label>
                        <progress value={userData.level_progress} max="100"
                                  className={"level-progress"}></progress>
                        <label
                            className={"personal-information-value"}>{userData.level_progress}%</label>
                      </div>
                      <div className={"personal-information-group"} style={{
                        display: 'flex',
                        justifyContent: 'flex-start',
                        alignItems: 'center',
                        marginBottom: '10px' }}>
                        <label className={"personal-information-label"} style={{ width: '150px' }}>Ranking:</label>
                        <label className={"personal-information-value"}>{userData.ranking}</label>
                      </div>
                    </div>
            ...
            <div style={{display: 'flex', flexDirection: 'row',justifyContent:'center'}}>
              <div style={{
                ...
                <label style={{fontWeight: 'bold', fontSize: '20px',marginBottom:'10px',color:'#495D44'}}>Activity Progress</label>
                {userAchievement && (
                    ...
                    <div className={"current-1"} >
                      <div className={"current-1-info"}>
                        ...
                        <div className={"current-1-info-column"}>
                          ...
                          <progress value={userAchievement.quiz_completed} max="10"></progress>
                        </div>
                        {!badgeLocks[0] ? ( // Check if badge is unlocked
                            <CheckCircleOutlineIcon style={{ width:'30px',height:'30px',color:"green",display:"flex",alignItems:'center',justifyContent:'center',marginLeft:'auto',marginRight:'auto',marginTop:'auto',marginBottom:'auto' }} />
                            ...
                            <LockIcon style={{ width:'30px',height:'30px',color:"#F13535",display:"flex",alignItems:'center',justifyContent:'center',marginLeft:'auto',marginRight:'auto',marginTop:'auto',marginBottom:'auto' }} />
                      ...
                      <div className={"current-1-info"}>
                        ...
                        <div className={"current-1-info-column"}>
                          ...
                          <progress value={userAchievement.lecture_hours} max="10"></progress>
                        </div>
                      ...
                      <div className={"current-1-info"}>
                        ...
                        <div className={"current-1-info-column"}>
                          ...
                          <progress value={userAchievement.projects_completed} max="5"></progress>
                        </div>
                      ...
                      <div className={"current-1-info"}>
                        ...
                        <div className={"current-1-info-column"}>
                          ...
                          <progress value={userAchievement.crops_planted} max="6"></progress>
                        </div>
              ...
              <div style={{
                ...
                <label style={{fontWeight:'bold',fontSize:'20px',marginBottom:'20px',color:'#495D44'}}>Collected Badges</label>
                {renderBadgeItems()}
              </div>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <label style={{
                  fontSize: '25px',
                  fontWeight: 'bold',color: '#495D44'}}>Ranking</label>
              </div>
              ...
              {sortedGamificationData.map((data, index) => (
                  <div style={{
                    ...
                    <div key={index} style={{width:"100%",borderRadius:'10px'}}>
                      <div style={{
                        display: 'flex',
                        flexDirection: 'row',
                        alignItems: 'center',
