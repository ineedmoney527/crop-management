...
const Gamification = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5050/api/user/2")
      .then((response) => {
    ...
    axios
      .get("http://localhost:5050/api/userAchievement/2")
      .then((response) => {
    ...
    axios
      .get("http://localhost:5050/api/gamification")
      .then((response) => {
    ...
    return [
      ...
      <div key={index} className={"badge-item"}>
        ...
        <div style={{ display: "flex", justifyContent: "flex-start" }}>
          ...
          {!badgeLocks[badge.index] && (
            <ShareIcon
              onClick={() => {
                navigate("/AddNewPost", {
                  state: {
                    defaultText: `I am glad to share that I have completed the ${badge.title} achievement! It was an exciting journey of learning and growth, and I'm proud to have reached this milestone. Looking forward to applying my new skills and knowledge to future planting endeavors. Thank you to everyone who supported me along the way! #AchievementUnlocked #LearningAndDevelopment`,
                    image: badge.image,
                  },
                });
              }}
